...
.e-toolbar.e-extended-toolbar.e-bigger .e-toolbar-pop .e-toolbar-item {
  height: 48px;
}
...
.e-toolbar.e-extended-toolbar.e-bigger .e-toolbar-pop .e-toolbar-item .e-tbar-btn.e-btn .e-icon-left {
  padding-right: 16px;
}
