...
export declare class NgForm extends ControlContainer implements Form, AfterViewInit {
    ...
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<NgForm, "form:not([ngNoForm]):not([formGroup]),ngForm,[ngForm]", ["ngForm"], { "options": "ngFormOptions"; }, { "ngSubmit": "ngSubmit"; }, never, never, false>;
}
